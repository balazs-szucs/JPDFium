...
# Overlay port: fetch freetype from the GitHub mirror instead of
# gitlab.freedesktop.org, which is chronically flaky (repeated 502/504
# timeouts on the GitHub Windows runners break the whole windows-* natives
# build). The GitHub tag archive is byte-identical to the gitlab one (same
# SHA512), so the rest of the port is unchanged from upstream.
vcpkg_from_github(
